...
import snikolas.hortikulturnimonitor.model.FlowerPowerMetadata;
import snikolas.hortikulturnimonitor.persistency.PersistencyManager;
import snikolas.hortikulturnimonitor.util.Util;
import snikolas.hortikulturnimonitor.util.ValueMapper;
 ...
 */
public class FlowerPowerService extends Service implements snikolas.hortikulturnimonitor.service.IFlowerPowerDevice
{
...
//			Log.i(FlowerPowerConstants.TAG, "FlowerPowerService.onCharacteristicChanged()");
	...
	private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic)
	{
		...
		{
			FlowerPowerMetadata.FlowerPowerColors color = null;
			int i = data[1] * 256 + data[0];
			switch(i)
			{
				case 4: color = FlowerPowerMetadata.FlowerPowerColors.BROWN; break;
				case 6: color = FlowerPowerMetadata.FlowerPowerColors.GREEN; break;
				case 7: color = FlowerPowerMetadata.FlowerPowerColors.BLUE; break;
				default: color = FlowerPowerMetadata.FlowerPowerColors.UNKNOWN;
			}	
